...
public class BoardUtils {
    ...
    private BoardUtils(){ // exception if you cant instantiate it
    ...
    public static boolean isValidTitleCoordinate(final int coordinate){ //checking if you are in range of board
